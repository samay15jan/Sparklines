...
const MenuContainer = styled.div`
  ${tw`p-2 w-60 rounded-md grid grid-cols-1 bg-[#282828]`}
`
...
const SubHeading = styled.div`
  ${tw`text-left cursor-pointer py-1 rounded-md text-sm opacity-50`}
`
const Image = styled.img`
  ${tw`rounded-full w-20 mb-2 p-2`}
`

const Menu = ({ userdata, handleLogout }) => {
  // TODO: integrate updating profile and languages
  return (
    <MenuContainer>
