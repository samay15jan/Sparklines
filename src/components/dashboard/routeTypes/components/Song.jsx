    ...
    <div>
      ...
      >
        <div className='flex gap-4'>
          <h1 className={index + 1 < 10 ? 'mr-3 pt-2 text-sm font-medium' : 'mr-1 pt-2 text-sm font-medium'}>
            {hover ? <FaPlay className='mt-1 ml-[-6px] pl-1' size={12} /> : index + 1}
          </h1>
          <div className='flex text-sm'>
            <div>
              <h1 className='font-bold'>{songData?.name || name || 'Unknown'}</h1>
        ...
        <h1 className='pt-2 font-medium mr-2 text-sm opacity-80'>{formatTime(songData?.duration) || time || '0:00'}</h1>
      </div>
