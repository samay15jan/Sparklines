    ...
    >
      <div>
        ...
        <button
          className={
            theme === 'light'
              ? 'text-black bg-white text-4xl absolute right-5 top-5 z-50 p-4 rounded-full'
              : 'text-white bg-black text-4xl absolute right-5 top-5 z-50 p-4 rounded-full'
          }
        >
          {menuIcon2}
        </button>
        ...
        <img
          className={
            theme === 'light' ? 'opacity-50 rounded-[50px]' : 'rounded-[50px]'
          }
          src={image}
        />
      </div>
