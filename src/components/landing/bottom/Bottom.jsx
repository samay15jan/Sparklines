...
const Heading = styled.span`${tw`drop-shadow-md text-4xl font-black opacity-80`}
...
const SubHeading = styled.div`${tw`drop-shadow-xl text-lg font-bold opacity-70 mt-5`}`

const Bottom = () => {
  return (
    <div className='overflow-x-hidden mt-20'>
      <img src='/icons/background.png'  className='absolute w-screen h-3/5 mt-20 opacity-30 drop-shadow-2xl right-10'/>
      <div className='absolute right-80 flex mb-5'>
        <div className='mt-3 w-12 h-12 rounded-full bg-black bg-yellow-400' />
        <div className='w-6 h-12 rounded-r-full mt-3 bg-[#dad4f1]' />
        <div className='w-6 h-12 rounded-r-full mt-3 bg-[#dad4f1]' />
        <div className='font-semibold text-md mt-4 ml-2'>Access to millions of  songs <br /> on <b>your fingertips...</b></div>
      </div>
      <div className='relative left-72 flex gap-4'>
        ...
        />
        <div
          className='w-44 h-80 rounded-t-[100px] rounded-b-[50px] bg-gradient-to-r from-purple-300 to-yellow-300'
        />
        <img
        ...
        />
        <div
          className='w-44 h-44 rounded-full mt-28 bg-gradient-to-l from-purple-300 to-yellow-300'
        />
      </div>
      ...
      <div className='relative bottom-40 left-16'>
        <Heading>
          A OpenSource Alternative <br /> for all your needs
        </Heading>
        <SubHeading>
          Create personalized playlists and find music you love, anytime,<br /> anywhere, on all your devices - <b>Exclusively for you.</b>
        </SubHeading>
      </div>
